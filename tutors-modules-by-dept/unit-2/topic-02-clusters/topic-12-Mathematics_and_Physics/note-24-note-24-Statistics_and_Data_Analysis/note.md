...
The module aims to develop the learner's competence in the application of modern techniques of data analysis in the context of analytical method development.

<p><a href="./archives/A00914.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A00914 |
| **Module Title** | Statistics and Data Analysis |
...
| - Tutorial/Problem Sheets | 1,2 | 30% |
| - Practical | 3 | 30% |
| - In-Class Assessment | 4,5,6 | 40% |
...
- Montgomery, D.C. _Introduction to Statistical Quality Control_. 7th ed. New York: Wiley, 2013.
...
*Module Code: A00914 | Timetable Code: STAT-0052*