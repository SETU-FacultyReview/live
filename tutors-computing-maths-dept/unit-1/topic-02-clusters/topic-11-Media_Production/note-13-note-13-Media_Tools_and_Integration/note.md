...
This module builds on the student's existing knowledge of audio/visual recording and editing and concentrates on software tool-specific features.

<p><a href="./archives/A13952.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A13952 |
| **Module Title** | Media Tools and Integration |
...
- "DJ Tech Tools." http://www.djtechtools.com
...
*Module Code: A13952 | Timetable Code: COMP-0670 | Change Tracking: Enabled*