...
<p><a href="./archives/A14882.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A14882 |
| **Module Title** | Project 2 IT (Prototyping) |
...
40%-49%: Produces prototype to minimum requirements. Produces full et of documentation. Able to demonstrate own work in competent manner.
...
*Module Code: A14882 | Timetable Code: COMP-0657 | Change Tracking: Enabled*