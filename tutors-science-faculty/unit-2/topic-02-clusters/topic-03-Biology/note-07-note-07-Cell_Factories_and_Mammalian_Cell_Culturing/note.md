...
icon:
  ...
  color: 00897B
---
# Cell Factories & Cell Culture

This module will investigate and compare the use of a variety of host cell systems, including microbial, insect, plant and mammalian, for the production of biopharmaceuticals.

<p><a href="./archives/A13832.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A13832 |
| **Module Title** | Cell Factories and Mammalian Cell Culturing |
...
|---------------------|----------------------|---------------|
| **Final Written Examination** | 1,3,4,5,6 | **60%** |
