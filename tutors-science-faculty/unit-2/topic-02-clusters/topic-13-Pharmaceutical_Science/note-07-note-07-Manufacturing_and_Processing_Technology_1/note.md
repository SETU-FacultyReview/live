...
icon:
  ...
  color: 00ACC1
---
# Manufac & Process Technology 1

This module provides an introduction to the processes, equipment and unit operations within the pharmaceutical industry.

<p><a href="./archives/A11413.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A11413 |
| **Module Title** | Manufacturing and Processing Technology 1 |
...
|---------------------|----------------------|---------------|
| **Final Written Examination** | 5,6,7,8 | **50%** |
...
|-------------------|---------------------|-----------|--------------|------------|
| [WD_SGMPT_C](/topic/setu-science-faculty/unit-2/topic-01-programmes/unit-01-level_6/topic-01-WD_SGMPT_C) | [Higher Certificate in Science in Good Manufacturing Practice and Technology](/topic/setu-science-faculty/unit-2/topic-01-programmes/unit-01-level_6/topic-01-WD_SGMPT_C) | 2 | 3 | Mandatory |
