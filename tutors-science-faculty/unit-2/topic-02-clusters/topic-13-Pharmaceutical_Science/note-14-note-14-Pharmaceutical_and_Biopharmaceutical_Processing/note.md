...
This module describes the overall operation, unit processes, and key parameters involved in the scale-up and production of pharmaceutical drug substances and biopharmaceutical products.

<p><a href="./archives/A26741.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A26741 |
| **Module Title** | Pharmaceutical and Biopharmaceutical Processing |
...
| - In-Class Assessment | 1,6 | 15% |
| - Presentation | 1,2,3,4,5 | 15% |
...
*Module Code: A26741 | Timetable Code: SCIE-0078 | Change Tracking: Enabled*