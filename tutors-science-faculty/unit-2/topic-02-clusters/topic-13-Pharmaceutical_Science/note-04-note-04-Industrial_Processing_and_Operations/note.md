...
icon:
  ...
  color: 00ACC1
---
# Industrial Processing and Ops

This module describes the overall operation, unit processes, equipment and documentation utilised in the modern pharmaceutical and biopharmaceutical industries.

<p><a href="./archives/A34181.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A34181 |
| **Module Title** | Industrial Processing and Operations |
...
| - Assignment | 3 | 20% |
| - Group Project | 5 | 10% |
| - In-Class Assessment | 1,2,3,4 | 70% |
...
*Module Code: A34181 | Timetable Code: SCIE-0066 | Change Tracking: Enabled*