...
This module introduces data communications terminology and concepts, network protocols and models.

<p><a href="./archives/A13487.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A13487 |
| **Module Title** | Computer Networks (ICT Skills) |
...
- Dye, M., R. McDonald and A. Rufi. _Network Fundamentals: CCNA Exploration Companion Guide (Cisco Networking Academy)_. New York: Cisco Press, 2011.
...
*Module Code: A13487 | Timetable Code: COMP-0519 | Change Tracking: Enabled*