...
This module introduces students to the capabilities of cloud computing, especially when applied to agricultural applications.

<p><a href="./archives/A21781.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A21781 |
| **Module Title** | Cloud Computing for Agri-Food |
...
- Morris, K. _Infrastructure as Code: Managing Servers in the Cloud_. New York: O'Rielly Media, 2016.
...
| WD_SAFICT_G | HDip in Science in Agri-Food ICT Systems | 5 | 2 | Mandatory |
