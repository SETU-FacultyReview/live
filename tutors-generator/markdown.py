"""
Markdown generation utilities for SETU catalogue generators.

This module contains functions for generating markdown content from module descriptors,
including module pages with structured information, tables, and frontmatter.
"""
