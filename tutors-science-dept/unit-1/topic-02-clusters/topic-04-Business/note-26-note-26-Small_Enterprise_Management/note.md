...
To familiarise students with the key concepts and business theories relating to starting your own business within an Irish context.

<p><a href="./archives/A05076.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A05076 |
| **Module Title** | Small Enterprise Management |
...
1. Distinguish the main types of business entity.
2. Examine a new business idea and develop a business strategy.
3. Analyse the marketing of a specific product or a range of products.
4. Determine the basic financial issues facing small businesses.
5. Determine the tax issues relating to a start-up business.
6. Examine the issues relevant to human resource management.
...
Class discussion on lecture content.
...
- O'Hara, B. . _Entrepreneurship in Ireland_. 1st ed.. Ireland: Gill and Macmillan Ltd, 2011.
