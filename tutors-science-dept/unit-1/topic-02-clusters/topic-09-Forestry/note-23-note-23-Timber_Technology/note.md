...
In this module students will deal with wood as an end product rather than as a raw material.

<p><a href="./archives/A09842.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A09842 |
| **Module Title** | Timber Technology |
...
|---------------------|----------------------|---------------|
| **Final Written Examination** | 4,5,6,7 | **50%** |
| **Continuous Assessment** |  | **50%** |
| - Assignment | 1,2,3,8 | 35% |
| - In-Class Assessment | 1,2,6,7 | 15% |
...
- Davies, I. and G. Watt. _Making the Grade -- A guide to appearance grading UK grown hardwood timber._. Scotland: Forestry Commission Scotland, Arcamedia, 2005.
...
*Module Code: A09842 | Timetable Code: FORS-0006 | Change Tracking: Enabled*