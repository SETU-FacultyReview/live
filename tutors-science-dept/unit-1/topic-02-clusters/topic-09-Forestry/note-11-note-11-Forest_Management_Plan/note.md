...
This is a 10 credit module whose final outcome is a comprehensive five-year Forest Management Plan for a medium-sized property.

<p><a href="./archives/A11664.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A11664 |
| **Module Title** | Forest Management Plan |
...
|---------------------|----------------------|---------------|
| **Final Written Examination** | 2,3,4 | **25%** |
| **Continuous Assessment** |  | **75%** |
| - Assignment | 3,4 | 25% |
| - Project | 1,2,5,6,7,8 | 50% |
