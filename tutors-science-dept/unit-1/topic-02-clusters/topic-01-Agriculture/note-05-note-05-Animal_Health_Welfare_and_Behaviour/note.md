...
icon:
  ...
  color: 689F38
---
# Animal Health, Welfare & Behav

The aim of this module is to provide students with an in-depth understanding of different physiological systems in the body.

<p><a href="./archives/A07889.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A07889 |
| **Module Title** | Animal Health, Welfare and Behaviour |
...
|---------------------|----------------------|---------------|
| **Final Written Examination** | 1,2,3,4,5,6,7 | **60%** |
| **Continuous Assessment** |  | **40%** |
| - In-Class Assessment | 1,2,3,4,5,6,7 | 20% |
| - Project | 8 | 20% |
...
*Module Code: A07889 | Timetable Code: AGRI-0107 | Change Tracking: Enabled*