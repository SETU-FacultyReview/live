...
This module covers aspects of quality management, including advanced quality systems such as Lean Manufacturing, Six Sigma and Risk Management, instrument validation and calibration management systems.

<p><a href="./archives/A07601.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A07601 |
| **Module Title** | Advanced Quality Methodologies |
...
|---------------------|----------------------|---------------|
| **Final Written Examination** | 1,2,4 | **60%** |
