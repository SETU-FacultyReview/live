...
This module covers aspects of quality management including teamwork, continuous improvement, the philosophy of total quality management (TQM), the quality gurus: Deming, Crosby, Juran, training and problem-solving.

<p><a href="./archives/A09762.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A09762 |
| **Module Title** | Total Quality Management (GMP) |
...
- The Seven Quality tools: Pareto, ishikawa, histograms, statistical process control, process capability, checksheets, trending of data; problem-solving techniques
...
- Oakland, J.S. _Statistical Process Control_. Oxford: Butterworth Heinmann, 2005.
...
- George, M.L., D. Rowlands, M. Price and J. Maxey. _Lean Six Sigma Pocket Toolbook_. New York: Mc-Graw Hill, 2005.
- Juran, J.M. _Juran's Quality Handbook_. London: Mc-Graw Hill, 2010.
...
*Module Code: A09762 | Timetable Code: QUAL-0012 | Change Tracking: Enabled*