...
During the placement period students are given the opportunity to complete work placement in an industrial or research environment.

<p><a href="./archives/A14865.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A14865 |
| **Module Title** | Placement (Physics) |
...
| - Portfolio | 1,6 | Pass/Fail% |
| - Reflective Journal | 4,5 | Pass/Fail% |
| - Supervisor's Report | 2,3,4 | Pass/Fail% |
...
- "Effective Practice in Industrial Work Placement: A Physical Sciences Practice Guide (2009)." https://www.heacademy.ac.uk/sites/default/files/effective_practice_in_industrial_work_placement.pdf
...
*Module Code: A14865 | Timetable Code: PLAC-0151 | Change Tracking: Enabled*