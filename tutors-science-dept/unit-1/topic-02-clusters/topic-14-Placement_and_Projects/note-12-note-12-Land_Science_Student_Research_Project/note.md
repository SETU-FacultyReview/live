...
This module consists of a research and development project, which aims to give students the facility to plan and carry out a programme of work based significantly on their own initiative.

<p><a href="./archives/A32004.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A32004 |
| **Module Title** | Land Science Student Research Project |
...
- **Pre-requisites:** Land Science Research Methods
- **Co-requisites:** None
...
- Bell, J. and S. Walters. _Doing Your Research Project; A guide for first-time researchers_. 6th ed. UK: Open University, 2014.
- Various, A. _Research papers and references_. Anywhere: Various, Various.
