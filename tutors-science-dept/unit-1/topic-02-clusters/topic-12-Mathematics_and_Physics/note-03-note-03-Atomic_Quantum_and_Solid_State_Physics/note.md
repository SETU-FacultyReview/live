...
icon:
  ...
  color: 00838F
---
# Atomic, Quantum & Solid State

In this module the student meets formal quantum mechanics for the first time.

<p><a href="./archives/A06812.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A06812 |
| **Module Title** | Atomic, Quantum and Solid State Physics |
