...
This module introduces the student to digital devices and systems.

<p><a href="./archives/A27463.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A27463 |
| **Module Title** | Electronic Devices and Systems |
...
Laboratory-based practicals: An integrated practical programme is designed to run in parallel with lectures. This will allow the student to develop experimental skills in the design and construction of a range of combinational and sequential circuits. The importance of planning of experiments, data acquisition, and data analysis will be emphasised throughout.
...
- Floyd, T. _Digital Fundamentals_. 11th ed. USA: Prentice-Hall, 2014.
- Harris, D. and S. Harris. _Digital Design and Computer Architecture_. 2nd ed. USA: Morgan Kaufmann, 2012.
- Storey, N. _Electronics: A Systems Approach_. 5th ed. UK: Pearson, 2013.
- Wakerly, J. _Digital Design: Principles and Practices_. 4th ed. USA: Prentice-Hall, 2005.
