...
<p><a href="./archives/A11330.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
4. Describe chemical equilibrium including equlibrium constant and Le Chatelier's principle.
...
- Atomic structure, atomic bonding and intermolecular forces and their effect s on properties (chemical and physical) of chemical reagents.
...
|---------------------|----------------------|---------------|
| **Final Written Examination** | 1,2,3,4,5 | **40%** |
...
*Module Code: A11330 | Timetable Code: CHEM-0018 | Change Tracking: Enabled*