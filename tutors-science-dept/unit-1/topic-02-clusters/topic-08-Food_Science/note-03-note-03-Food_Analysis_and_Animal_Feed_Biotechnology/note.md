...
icon:
  ...
  color: EF5350
---
# Food Analysis Animal Feed Bio

This module introduces the student to basic food analysis.

<p><a href="./archives/A36344.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A36344 |
| **Module Title** | Food Analysis and Animal Feed Biotechnology |
| **Short Title** | Food Analysis Animal Feed Bio |
| **Credits** | 5 ECTS |
| **Level** | Intermediate |
...
1. Use safe laboratory procedures including the correct disposal of laboratory waste.
2. Complete proximate and microbiological analysis on a range of food products and animal feeds.
3. Communicate results from report laboratory experiments in an appropriate format and evaluate the data.
4. Analyse various Food Analysis experiments and their uses in the food industry.
5. Differentiate the various types of animal feeds and their microbial/non-microbial composition.
6. Analyse regulations, food safety concerns of GMO`s and the basics of animal clinical trials.
...
- Laboratory safety and safe disposal of chemicals
- Food analysis tests, including some microbiological analysis
- An introduction to probiotics, prebiotics and zenobiotics in a range of animal feeds ( including animal clinical trials)
- Innovative application of microorganisms as novel food packaging systems
- The marine environment and the agri/food industry
- GMO`s in the agri/food sector
...
- "Module, Food Analysis and Animal Feed Biotechnology." www.moodle.wit.ie
