...
This module extends and deepens the students' knowledge of food processing technologies already taken at ordinary degree level.

<p><a href="./archives/A07826.pdf" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; text-decoration: none;"><img src="https://upload.wikimedia.org/wikipedia/commons/6/60/Adobe_Acrobat_Reader_icon_%282020%29.svg" width="20" height="20" style="margin-right: 4px;" alt="Adobe Acrobat Icon"><span>Module Descriptor (PDF)</span></a></p>
...
|-----------|-------------|
| **Module Code** | A07826 |
| **Module Title** | Food Process Technology 2 |
...
|---------------------|----------------------|---------------|
| **Final Written Examination** | 3,4 | **50%** |
